                ...
                <VuePerfectScrollbar ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-2" :settings="settings"
                    ...
                    <template v-for="(item, index) in menuItemsUpdated">
                        ...
                        <template v-else-if="!item.header">
                            ...
                            <!-- /Nav-Group -->
                            <a class="text-white absolute bottom-0 ml-2" style="font-size: 1.125rem" href="mailto:support@zbkbank.com">support@zbkbank.com</a>
                        </template>
                    </template>
<!--                    <v-nav-menu-item-->
<!--                        v-if="isOperator"-->
...
<!--                        :isDisabled="false"-->
<!--                        :slug="`external`">-->
<!--                        <span v-show="!verticalNavMenuItemsMin" class="truncate">Оператор</span>-->
<!--                    </v-nav-menu-item>-->
                </VuePerfectScrollbar>
                <!-- /Menu Items -->
            </div>
